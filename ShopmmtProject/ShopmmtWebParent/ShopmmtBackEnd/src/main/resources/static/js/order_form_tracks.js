	...
	htmlCode = `
			<div class="row border rounded p-1" id="${rowId}">
				...
				<div class="col-2">
					...
					<div class="mt-1"><a class="fas fa-trash icon-red linkRemoveTrack" href="" rowNumber="${nextCount}" title="Xóa khỏi tracking"></a></div>					
				</div>				
				...
				<div class="col">
					<select name="trackStatus" class="form-select dropDownStatus" required style="max-width: 300px" rowNumber="${nextCount}">
			`;
