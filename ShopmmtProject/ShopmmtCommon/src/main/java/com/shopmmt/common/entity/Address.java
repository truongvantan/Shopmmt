...
public class Address {
	...
	public Address(AddressFormDTO addressFormDTO) {
		this.id = addressFormDTO.getId();
		this.firstName = addressFormDTO.getFirstName();
		this.lastName = addressFormDTO.getLastName();
		this.phoneNumber = addressFormDTO.getPhoneNumber();
		this.addressLine1 = addressFormDTO.getAddressLine1();
		this.addressLine2 = addressFormDTO.getAddressLine2();
		this.city = addressFormDTO.getCity();
		this.state = addressFormDTO.getState();
		this.postalCode = addressFormDTO.getPostalCode();
		this.defaultForShipping = addressFormDTO.isDefaultForShipping();
	}
